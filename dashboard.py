...
# --- 2. AUTHENTICATION GATE (EXACT REPLICA) ---
...
assets = [
    ...
    {"name": "Wasatch Holding", "confidence": "99% VERIFIED", "vehicle": "Layered Trust", "status": "PROTECTED"}
]
    ...
    with cols[i % 3]:
        card_html = f"""
            <div class="gold-card">
                ...
                <div class="label-white">CONFIDENCE LEVEL</div>
                <div class="value-white">{asset['confidence']}</div>
                <div class="label-white">VEHICLE TYPE</div>
...
st.markdown(f"""
    <div style="display: flex; justify-content: center; gap: 30px; opacity: 0.8; font-size: 11px; font-family: 'Oswald'; color: #1d428a;">
        <div style="display: flex; align-items: center;"><span class="green-pulse" style="height:6px; width:6px; margin-right:5px;"></span>NODE: UTAH_PRIMARY_SYNC</div>
        <div>STATUS: ENCRYPTED & SECURE</div>
        <div style="font-weight: bold;">© 2026 UTAH LAND & PROPERTY | WEALTH PROTECTION</div>
    </div>
""", unsafe_allow_html=True)
