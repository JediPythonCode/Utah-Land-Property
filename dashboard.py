...
st.markdown(
    ...
    <div class="hero-container">
        ...
        <div class="hero-subtitle">Utah Real Estate Contracts For Sale. Wholesale Utah Real Estate & Land Contracts For Sale. </div>
    </div>
...
def load_utah_property_database():
    data = [
        ...
        },
        {
            ...
            "sqft": 920,
            "status": "UNDER CONTRACT",
            "address": "3691 S 2000 E, Salt Lake City, UT 84109",
            "broker": "Utah Land & Property Inc.",
