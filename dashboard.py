...
<style>
:root {{ --bhhs-cabernet: #631D33; --overlay: rgba(0,0,0,0.3); }}
...
<section id="hero-section" class="hero-container">
    <header class="absolute top-0 left-0 p-10 flex flex-col">
    ...
    <div class="z-10 px-6 text-center">
        ...
        <div class="action-bar mx-auto">
            ...
            <button onclick="handleLogin()" class="action-button">Access Vault</button>
        </div>
        <p class="mt-6 text-[10px] text-gray-200">
    ...
    <div class="max-w-7xl mx-auto px-10 mt-16">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
            <div class="glass-card accent-border p-10">
                <div class="text-[10px] uppercase tracking-[3px] text-gray-400 mb-2 font-bold">Portfolio Summary</div>
                <div class="text-4xl font-serif font-bold text-[var(--bhhs-cabernet)]">$8,740,200</div>
                <div class="text-[10px] text-emerald-600 mt-3 font-bold tracking-widest uppercase">Active Investment Strategy</div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div class="glass-card p-12 h-[500px] flex flex-col">
                <h2 class="font-serif text-3xl mb-8">Portfolio Trajectory</h2>
            ...
            <div class="glass-card p-12">
                ...
                <div class="space-y-6">
                     ...
                     <div>
                        <label class="text-[10px] uppercase font-bold text-gray-400">Contracts / Addenda</label>
                     ...
                     <div class="pt-6">
                        <button onclick="handleExecution()" class="w-full bg-[var(--bhhs-cabernet)] text-white py-4 font-bold uppercase tracking-[2px] text-xs">Execute / Preview Contract</button>
                     </div>
                </div>
            </div>
        </div>
...
with st.sidebar:
    ...
    with st.expander("Contract Settings", expanded=True):
